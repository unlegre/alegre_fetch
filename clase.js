...
function calcular_prestamo (monto_1,cuotas_1){
  if( cuotas_1 == 3){
    ...
    Swal.fire({
      text:" ingrese una cuota entre : 3 , 6 , 12 y 18 ",
    })
...
boton_simulador.addEventListener("click",function(){
  Swal.fire({
    text:"Siga los pasos para su prerstamos",
         ...
         //   empieza funcion simulador de Prestamo
    ...
    Swal.fire({
      text:"usted va a pagar :"+" "+cuotas_1+" "+"cuotas de :"+total_prestamo,
         ...
         //   termina funcion simulador de Prestamo
      ...
      Toastify({
        ...
        function dar_prestamo(){
            ...
            console.log(JSON.parse(recuperando_data_json));
              ...
              //  funcion btn_calculo_total
         $("#btn_calculo_total").click(function(){
          let importe_cuotas = document.getElementById("importe_cuotas").value;
          let Cantidad_cuotas = document.getElementById("Cantidad_cuotas").value;
          let total_a_pagar = Number(importe_cuotas) / Number(Cantidad_cuotas) ;

          Swal.fire({
            text:"Usted va a Pagar: "+ total_a_pagar,  // con el + agregue :total_a_pagar dentro del Swall
            ...
            $("#btn_Temperatura").click(function(){
              fetch("https://api.openweathermap.org/data/2.5/weather?q=Moron&lang=es&units=metric&appid=bbf8893c6e8030e157bb633d11a66e17")
              .then(Response => Response.json())
              .then(data =>{
                Swal.fire({
                  text:" La temperatura  en grados es :"+data.main.temp,  // con el + agregue :data.main.temp dentro del Swall
                })
